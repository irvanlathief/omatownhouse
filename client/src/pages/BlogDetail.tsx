...
//
// The site-wide AI drawer is mounted by App, outside the article render path,
// so BlogArticleView remains pure and compatible with prerendering.
export default function BlogDetail() {
  ...
  const baked =
    ...
    (window as any).__BLOG_ARTICLE__?.slug === slug
