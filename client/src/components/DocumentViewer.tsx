...
const DOCUMENTS: Document[] = [
  ...
  },
  {
    ...
    pages: [
      ...
      { kind: "image", image: `${RENDER_CDN}/Scene23.webp`, caption: "Street view", alt: "OMA Townhouse from the street" },
      { kind: "image", image: `${RENDER_CDN}/Scene26.webp`, caption: "Private pool", alt: "Private pool and deck" },
      { kind: "image", image: `${RENDER_CDN}/Scene32.webp`, caption: "Living area", alt: "Open-plan living area" },
      { kind: "image", image: `${RENDER_CDN}/Scene33.webp`, caption: "Entryway", alt: "Entryway and staircase" },
      { kind: "image", image: `${RENDER_CDN}/Scene39.webp`, caption: "Kitchen", alt: "Kitchen island" },
      { kind: "image", image: `${RENDER_CDN}/Scene41.webp`, caption: "Home office", alt: "Study and home office" },
      { kind: "image", image: `${RENDER_CDN}/Scene51.webp`, caption: "Bathroom", alt: "Bathroom" },
      { kind: "image", image: `${RENDER_CDN}/Scene52.webp`, caption: "Living and kitchen", alt: "Living area and kitchen" },
      { kind: "image", image: `${RENDER_CDN}/Scene76.webp`, caption: "Bedroom", alt: "Bedroom" },
      { kind: "image", image: `${RENDER_CDN}/Scene77.webp`, caption: "Bedroom (TV wall)", alt: "Bedroom with built-in wardrobe and TV" },
    ],
  },
  {
    id: "pricing",
