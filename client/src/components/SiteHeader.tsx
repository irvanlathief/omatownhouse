// Reusable top navigation header, shared by the homepage and the blog pages.
// Pure and SSR-safe (no hooks, tRPC, wouter or browser APIs); uses a plain
// <a href="/"> so it can be rendered anywhere.
