    ...
    <>
      {!chat.isChatOpen && (
        <button
          ...
          className="oma-guide-trigger fixed bottom-5 right-5 z-[70] flex items-center gap-3 rounded-full bg-black px-4 py-3 text-sm font-medium text-white shadow-[0_16px_45px_rgba(0,0,0,0.24)] transition-transform duration-300 hover:-translate-y-1 sm:bottom-7 sm:right-7 sm:px-5"
